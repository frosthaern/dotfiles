(custom-set-variables
 ...
 '(package-selected-packages
   '(evil-nerd-commenter evil-org evil-collection evil treesit-auto smex doom-modeline doom-themes ido-vertical-mode tree-sitter-langs tree-sitter all-the-icons)))
(custom-set-faces
...
(evil-define-key 'normal 'global (kbd "C-s") 'save-buffer)  ;; Save with `C-s`
